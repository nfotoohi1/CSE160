 ...
 */
 ...
 class Vector3 {
  ...
  static dot(v1, v2) {
      // Insert your code here.
      var a = v1.elements[0] * v2.elements[0];
      var b = v1.elements[1] * v2.elements[1];
      var c = v1.elements[2] * v2.elements[2];
      var d = a + b + c;
      /*var e = v1.magnitude();
      var f = v2.magnitude();
      var g = e * f;
      var h = not_d / g; */
      //var d = Math.cos(not_d);
      /*let d = 0;
      for (var i = 0; i < 3; ++i) {
        d += v1.elements[i] * v2.elements[i];
      }*/
      // Don't delete the return statement.
      return d;
  }
  ...
  static cross(v1, v2) {
      ...
      var a = (v1.elements[1] * v2.elements[2]) - (v1.elements[2] * v2.elements[1]);
      var b = (v1.elements[2] * v2.elements[0]) - (v1.elements[0] * v2.elements[2]);
      var c = (v1.elements[0] * v2.elements[1]) - (v1.elements[1] * v2.elements[0]);
  ...
  magnitude() {
      ...
      var a = this.elements[0] ** 2;
      var b = this.elements[1] ** 2;
      var c = this.elements[2] ** 2;
      var d = a + b + c;
      m = Math.sqrt(d);
      // Don't delete the return statement.
      return m;
